...
# Output Schema (JSON Only)
{
  ...
  "tags": ["記事に関連する重要キーワードを3〜5個配列で指定。可能な限り以下のカテゴリから既存のタグ（slugではなく日本語ラベルでOK）を選択すること：企業・プロダクト名（OpenAI, Google, Gemini, Claude, ChatGPT等）、技術トピック（LLM, RAG, 画像生成, 動画生成等）、ユースケース（業務効率化, 開発, クリエイティブ等）。汎用的な「AI」「技術」などは避け、具体的で検索されやすい固有名詞を優先する。"],
  "sections": [
